...
<div class="main">
  ...
  <div class="content">
    <div id="content-container">
      ...
      <form action="adduser.php" method="POST" class="add-form" autocomplete="off">
        ...
        <div class="form-buttons">
          <a href="user.php" id="cancel-btn">Cancel</a>
