...
<div class="main">
  ...
  <div class="content">
    <div id="content-container">
      ...
      <form action="addsupplier.php" method="POST" class="add-form" autocomplete="off">
        ...
        <div class="form-buttons">
          <a href="suppliers.php" id="cancel-btn">Cancel</a>
          <button type="submit" id="add-btn">Add Supplier</button>
        </div>
      </form>
    </div>
  </div>
