...
<div class="main">
  ...
  <div class="content">
    <div id="content-container">
      ...
      <form action="addstockmovement.php" method="POST" class="add-form" autocomplete="off">
        ...
        <div class="form-buttons">
          <a href="stock_movement.php" id="cancel-btn">Cancel</a>
          <button type="submit" id="add-btn">Record Movement</button>
        </div>
      </form>
    </div>
  </div>
